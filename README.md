...
- **Interactions:** Interact with objects, and the environment to discover clues and advance the story.  
...
## How to Download and Access the Game  

### 1. Clone the Repository  
- Ensure Git is installed on your system.  
- Run the following command to clone the game repository:  
  ```bash
...
- Download the .NET SDK from [this link](https://dotnet.microsoft.com/en-us/download) if required.  

### 3. Build the Game  
- Navigate to the game directory (where the `.csproj` file is located).  
...
### 5. Optional - Play From Save  
- If a save file (`save.json`) exists in the game directory, your progress will be loaded automatically when the game starts.  
