...
namespace Shattered_Protocols.Navigation
{
    ...
    internal class Map : IEventManagable
    {
        ...
        /// <summary>
        /// Adds RoomUnlock Constructor Methods to dictionary
        /// </summary>
        private void InitializeConstructorLibrary()
        {
            //Build RoomUnlock constructor dictionary
        ...
        /// <summary>
        /// Moves the current RoomUnlock to another direction if able
        /// </summary>
        ...
        /// <summary>
        /// returns a RoomUnlock object from the roomDictionary if it exists
        /// creates a new RoomUnlock object if needed
        /// used to ensure only one of each room type exists
        /// </summary>
        /// <param name="roomType">type of room to return</param>
        /// <returns>RoomUnlock object</returns>
        ...
        public void ManageMe()
        {
            ...
            GameController.Subscribe(EventType.DropInventory, OnDropItem);
        }
        public void UnManageMe()
        {
            //UnSubscribe to events here
            GameController.Unsubscribe(EventType.DropInventory, OnDropItem);
        }
        #endregion

        #region Events
        /// <summary>
        /// When the DropItem event is raised, move inventory from stored inventory to room inventory
        /// </summary>
        /// <param name="args">InventoryArgs event</param>
        internal virtual void OnDropItem(EventArgs args)
        {
            //Make sure correct eventtype
            if (args is InventoryArgs inventoryArgs)
            {
                Inventory source = inventoryArgs.Inventory;
                Inventory destination = currentRoom.Inventory;
